...
const Home = () => {
    ...
    return (
        ...
        <div className = 'text-center mt-[350px] mb-72'>
         ...
         <Button whereTo ="/register" value="Join now!"/>
        </div>
        ...
        <div className ="w-full h-[600px] mr-32 mt-64 pl-10">
            ...
            <Button whereTo ="/profile" value="See rewards"/> {/*change to /prizes once you make it*/ }
        </div>
        </>
    );
};
